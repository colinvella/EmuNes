...
namespace NesCore.Processing
{
    public class InstructionSet: IEnumerable
    {
        ...
        private void Initialise()
        {
            ...
            instructions[0x04] = new Instruction(0x04, "NOP", AddressingMode.ZeroPage, 3, IllegalOpCode);
            ...
            instructions[0x0C] = new Instruction(0x0C, "NOP", AddressingMode.Absolute, 4, IllegalOpCode);
            ...
            instructions[0x14] = new Instruction(0x14, "NOP", AddressingMode.ZeroPageX, 4, IllegalOpCode);
            ...
            instructions[0x1A] = new Instruction(0x1A, "NOP", AddressingMode.Implied, 2, IllegalOpCode);
            instructions[0x1B] = new Instruction(0x1B, "SLO", AddressingMode.AbsoluteY, 7, IllegalOpCode);
            instructions[0x1C] = new Instruction(0x1C, "NOP", AddressingMode.AbsoluteX, 4, IllegalOpCode);
            ...
            instructions[0x34] = new Instruction(0x34, "NOP", AddressingMode.ZeroPageX, 4, IllegalOpCode);
            ...
            instructions[0x3A] = new Instruction(0x3A, "NOP", AddressingMode.Implied, 2, IllegalOpCode);
            instructions[0x3B] = new Instruction(0x3B, "RLA", AddressingMode.AbsoluteY, 7, IllegalOpCode);
            instructions[0x3C] = new Instruction(0x3C, "NOP", AddressingMode.AbsoluteX, 3, IllegalOpCode);
            ...
            instructions[0x44] = new Instruction(0x44, "NOP", AddressingMode.ZeroPage, 3, IllegalOpCode);
            ...
            instructions[0x54] = new Instruction(0x54, "NOP", AddressingMode.ZeroPageX, 4, IllegalOpCode);
            ...
            instructions[0x5A] = new Instruction(0x5A, "NOP", AddressingMode.Implied, 2, IllegalOpCode);
            instructions[0x5B] = new Instruction(0x5B, "SRE", AddressingMode.AbsoluteY, 7, IllegalOpCode);
            instructions[0x5C] = new Instruction(0x5C, "NOP", AddressingMode.AbsoluteX, 4, IllegalOpCode);
            ...
            instructions[0x64] = new Instruction(0x64, "NOP", AddressingMode.ZeroPage, 3, IllegalOpCode);
            ...
            instructions[0x74] = new Instruction(0x74, "NOP", AddressingMode.ZeroPageX, 4, IllegalOpCode);
            ...
            instructions[0x7A] = new Instruction(0x7A, "NOP", AddressingMode.Absolute, 2, IllegalOpCode);
            instructions[0x7B] = new Instruction(0x7B, "RRA", AddressingMode.AbsoluteY, 7, IllegalOpCode);
            instructions[0x7C] = new Instruction(0x7C, "NOP", AddressingMode.AbsoluteX, 4, IllegalOpCode);
            ...
            // 0x80 - 0x8F
            instructions[0x80] = new Instruction(0x80, "NOP", AddressingMode.Immediate, 2, IllegalOpCode);
            instructions[0x81] = new Instruction(0x81, "STA", AddressingMode.IndexedIndirect, 6, StoreAccumulator);
            instructions[0x82] = new Instruction(0x82, "NOP", AddressingMode.Immediate, 2, IllegalOpCode);
            ...
            instructions[0x89] = new Instruction(0x89, "NOP", AddressingMode.Immediate, 2, IllegalOpCode);
            ...
            instructions[0xC2] = new Instruction(0xC2, "NOP", AddressingMode.Immediate, 2, IllegalOpCode);
            ...
            instructions[0xD4] = new Instruction(0xD4, "NOP", AddressingMode.ZeroPageX, 4, IllegalOpCode);
            ...
            instructions[0xDA] = new Instruction(0xDA, "NOP", AddressingMode.Implied, 2, IllegalOpCode);
            instructions[0xDB] = new Instruction(0xDB, "DCP", AddressingMode.AbsoluteY, 7, IllegalOpCode);
            instructions[0xDC] = new Instruction(0xDC, "NOP", AddressingMode.AbsoluteX, 4, IllegalOpCode);
            ...
            instructions[0xE2] = new Instruction(0xE2, "NOP", AddressingMode.Immediate, 2, IllegalOpCode);
            ...
            instructions[0xF4] = new Instruction(0xF4, "NOP", AddressingMode.ZeroPageX, 4, IllegalOpCode);
            ...
            instructions[0xFA] = new Instruction(0xFA, "NOP", AddressingMode.Implied, 2, IllegalOpCode);
            instructions[0xFB] = new Instruction(0xFB, "ISC", AddressingMode.AbsoluteY, 7, IllegalOpCode);
            instructions[0xFC] = new Instruction(0xFC, "NOP", AddressingMode.AbsoluteX, 4, IllegalOpCode);
